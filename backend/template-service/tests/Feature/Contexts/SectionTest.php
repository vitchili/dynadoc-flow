...
it('can create a section', function () {
    ...
    $response = postJson('/api/sections', [
        'name' => fake()->name(),
        'description' => fake()->title(),
        'templateId' => $templateId,
        'htmlContent' => '<html>OI</html>',
    ], [
        'Authorization' => $this->validBearerToken
    ]);
...
it('can update a section', function () {
    ...
    $responseSection = postJson('/api/sections', [
        'name' => fake()->name(),
        'description' => fake()->title(),
        'templateId' => $templateId,
        'htmlContent' => '<html>OI</html>',
    ...
    $sectionId = $responseSection['data'];

    $response = patchJson("/api/sections/{$sectionId}", [
        'name' => 'New Name',
...
it('can list sections by filters', function () {
    $responseTemplate = postJson('/api/templates', [
        'name' => 'My Template',
        'description' => 'A test template',
    ], [
    ...
    $response = getJson('/api/sections/filters?name=SearchedName', [
        'Authorization' => $this->validBearerToken
    ]);
...
it('can delete a section', function () {
    ...
    $response = deleteJson("/api/sections/{$sectionId}", [], [
        'Authorization' => $this->validBearerToken
    ]);
